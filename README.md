...
npm run test:campaign:2  # the same, then Movement II: shrine, hall, the Annex desk, the history, the board, Vesper, the Organs door (4 min deadline)
npm run test:campaign:3  # the same, then Movement III: the three organs, Ord's map, the garden, the bell, the forecast glass, Quill's forge, Movement IV (8 min deadline)
