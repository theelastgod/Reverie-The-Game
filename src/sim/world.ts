import {
  ...
  FRAME_PEOPLE_PLAQUE,
  framePeoplePoi,
  OBSERVER_PEOPLE_COPY,
  WINK_OBSERVER_PEOPLE,
  OBSERVER_PEOPLE_NEED,
  OBSERVER_PEOPLE_HELD,
  OBSERVER_PEOPLE_SPECTATOR,
  OBSERVER_PEOPLE_PLAQUE,
  observerPeoplePoi,
  PARTICIPANT_PEOPLE_COPY,
  WINK_PARTICIPANT_PEOPLE,
  PARTICIPANT_PEOPLE_NEED,
  PARTICIPANT_PEOPLE_HELD,
  PARTICIPANT_PEOPLE_SPECTATOR,
  PARTICIPANT_PEOPLE_PLAQUE,
  participantPeoplePoi,
  PROXIMITY_PEOPLE_COPY,
  WINK_PROXIMITY_PEOPLE,
  PROXIMITY_PEOPLE_NEED,
...
export function emptyWorld(): WorldState {
  return {
    ...
    clinicPeopleHeld: false,
    paperPeopleHeld: false,
    framePeopleHeld: false,
    observerPeopleHeld: false,
    participantPeopleHeld: false,
    proximityPeopleHeld: false,
    enterPeopleHeld: false,
    refusePeopleHeld: false,
    collectivePeopleHeld: false,
    studiosPeopleHeld: false,
    filmPeopleHeld: false,
    directorPeopleHeld: false,
    disarmedPeopleHeld: false,
    guestPeopleHeld: false,
    supplyPeopleHeld: false,
    combatPeopleHeld: false,
    earnPeopleHeld: false,
    angelPeopleHeld: false,
    messengerPeopleHeld: false,
    linkPeopleHeld: false,
    perceptionPeopleHeld: false,
    verbPeopleHeld: false,
    stylePeopleHeld: false,
    schoolPeopleHeld: false,
    optionalPeopleHeld: false,
    personalPeopleHeld: false,
    variantPeopleHeld: false,
    objectivePeopleHeld: false,
    questPeopleHeld: false,
    spokenPeopleHeld: false,
...
export function applyRead(w: WorldState, playerId: string, signId: string): WorldState {
  ...
  if (sign.id === WET_GRID.id || sign.id === "stormpress-people" || sign.id === "fallen-people" || sign.id === "spoils-people" || sign.id === "unflag-people" || sign.id === "seconds-people" || sign.id === "street-people" || sign.id === "geared-people" || sign.id === "serial-people" || sign.id === "band-people" || sign.id === "number-people" || sign.id === "skill-people" || sign.id === "trait-people" || sign.id === "token-people" || sign.id === "fair-people" || sign.id === "visible-people" || sign.id === "aura-people" || sign.id === "presence-people" || sign.id === "wink-people" || sign.id === "bestand-people" || sign.id === "cult-people" || sign.id === "copy-people" || sign.id === "banked-people" || sign.id === "unbanked-people" || sign.id === "sink-people" || sign.id === "yield-people" || sign.id === "tax-people" || sign.id === "gestell-people" || sign.id === "climate-people" || sign.id === "extract-people" || sign.id === "max-people" || sign.id === "heat-people" || sign.id === "fat-people" || sign.id === "poor-people" || sign.id === "block-people" || sign.id === "solo-people" || sign.id === "dwell-people" || sign.id === "trace-people" || sign.id === "fail-people" || sign.id === "hole-people" || sign.id === "stipend-people" || sign.id === "hijack-people" || sign.id === "absence-people" || sign.id === "wait-people" || sign.id === "stay-people" || sign.id === "willing-people" || sign.id === "empty-people" || sign.id === "walked-people" || sign.id === "leave-people" || sign.id === "kept-people" || sign.id === "hold-people" || sign.id === "capped-people" || sign.id === "prayer-people" || sign.id === "sold-people" || sign.id === "unlit-people" || sign.id === "live-people" || sign.id === "blind-people" || sign.id === "hour-people" || sign.id === "names-people" || sign.id === "residual-people" || sign.id === "equal-people" || sign.id === "addressed-people" || sign.id === "back-people" || sign.id === "seed-people" || sign.id === "invite-people" || sign.id === "parted-people" || sign.id === "together-people" || sign.id === "gather-people" || sign.id === "clinic-people" || sign.id === "paper-people" || sign.id === "frame-people" || sign.id === "observer-people" || sign.id === "participant-people" || sign.id === "proximity-people" || sign.id === "enter-people" || sign.id === "refuse-people" || sign.id === "collective-people" || sign.id === "studios-people" || sign.id === "film-people" || sign.id === "director-people" || sign.id === "disarmed-people" || sign.id === "guest-people" || sign.id === "supply-people" || sign.id === "combat-people" || sign.id === "earn-people" || sign.id === "angel-people" || sign.id === "messenger-people" || sign.id === "link-people" || sign.id === "perception-people" || sign.id === "verb-people" || sign.id === "style-people" || sign.id === "school-people" || sign.id === "optional-people" || sign.id === "personal-people" || sign.id === "variant-people" || sign.id === "objective-people" || sign.id === "quest-people" || sign.id === "spoken-people") {
    if (w.questPeopleHeld && !w.spokenPeopleHeld) return applySpokenPeople(w, playerId);
    if (sign.id === "spoken-people") return applySpokenPeople(w, playerId);
    if (w.objectivePeopleHeld && !w.questPeopleHeld) return applyQuestPeople(w, playerId);
    if (sign.id === "quest-people") return applyQuestPeople(w, playerId);
    if (w.variantPeopleHeld && !w.objectivePeopleHeld) return applyObjectivePeople(w, playerId);
    if (sign.id === "objective-people") return applyObjectivePeople(w, playerId);
    if (w.personalPeopleHeld && !w.variantPeopleHeld) return applyVariantPeople(w, playerId);
    if (sign.id === "variant-people") return applyVariantPeople(w, playerId);
    if (w.optionalPeopleHeld && !w.personalPeopleHeld) return applyPersonalPeople(w, playerId);
    if (sign.id === "personal-people") return applyPersonalPeople(w, playerId);
    if (w.schoolPeopleHeld && !w.optionalPeopleHeld) return applyOptionalPeople(w, playerId);
    if (sign.id === "optional-people") return applyOptionalPeople(w, playerId);
    if (w.stylePeopleHeld && !w.schoolPeopleHeld) return applySchoolPeople(w, playerId);
    if (sign.id === "school-people") return applySchoolPeople(w, playerId);
    if (w.verbPeopleHeld && !w.stylePeopleHeld) return applyStylePeople(w, playerId);
    if (sign.id === "style-people") return applyStylePeople(w, playerId);
    if (w.perceptionPeopleHeld && !w.verbPeopleHeld) return applyVerbPeople(w, playerId);
    if (sign.id === "verb-people") return applyVerbPeople(w, playerId);
    if (w.linkPeopleHeld && !w.perceptionPeopleHeld) return applyPerceptionPeople(w, playerId);
    if (sign.id === "perception-people") return applyPerceptionPeople(w, playerId);
    if (w.messengerPeopleHeld && !w.linkPeopleHeld) return applyLinkPeople(w, playerId);
    if (sign.id === "link-people") return applyLinkPeople(w, playerId);
    if (w.angelPeopleHeld && !w.messengerPeopleHeld) return applyMessengerPeople(w, playerId);
    if (sign.id === "messenger-people") return applyMessengerPeople(w, playerId);
    if (w.earnPeopleHeld && !w.angelPeopleHeld) return applyAngelPeople(w, playerId);
    if (sign.id === "angel-people") return applyAngelPeople(w, playerId);
    if (w.combatPeopleHeld && !w.earnPeopleHeld) return applyEarnPeople(w, playerId);
    if (sign.id === "earn-people") return applyEarnPeople(w, playerId);
    if (w.supplyPeopleHeld && !w.combatPeopleHeld) return applyCombatPeople(w, playerId);
    if (sign.id === "combat-people") return applyCombatPeople(w, playerId);
    if (w.guestPeopleHeld && !w.supplyPeopleHeld) return applySupplyPeople(w, playerId);
    if (sign.id === "supply-people") return applySupplyPeople(w, playerId);
    if (w.disarmedPeopleHeld && !w.guestPeopleHeld) return applyGuestPeople(w, playerId);
    if (sign.id === "guest-people") return applyGuestPeople(w, playerId);
    if (w.directorPeopleHeld && !w.disarmedPeopleHeld) return applyDisarmedPeople(w, playerId);
    if (sign.id === "disarmed-people") return applyDisarmedPeople(w, playerId);
    if (w.filmPeopleHeld && !w.directorPeopleHeld) return applyDirectorPeople(w, playerId);
    if (sign.id === "director-people") return applyDirectorPeople(w, playerId);
    if (w.studiosPeopleHeld && !w.filmPeopleHeld) return applyFilmPeople(w, playerId);
    if (sign.id === "film-people") return applyFilmPeople(w, playerId);
    if (w.collectivePeopleHeld && !w.studiosPeopleHeld) return applyStudiosPeople(w, playerId);
    if (sign.id === "studios-people") return applyStudiosPeople(w, playerId);
    if (w.refusePeopleHeld && !w.collectivePeopleHeld) return applyCollectivePeople(w, playerId);
    if (sign.id === "collective-people") return applyCollectivePeople(w, playerId);
    if (w.enterPeopleHeld && !w.refusePeopleHeld) return applyRefusePeople(w, playerId);
    if (sign.id === "refuse-people") return applyRefusePeople(w, playerId);
    if (w.proximityPeopleHeld && !w.enterPeopleHeld) return applyEnterPeople(w, playerId);
    if (sign.id === "enter-people") return applyEnterPeople(w, playerId);
    if (w.participantPeopleHeld && !w.proximityPeopleHeld) return applyProximityPeople(w, playerId);
    if (sign.id === "proximity-people") return applyProximityPeople(w, playerId);
    if (w.observerPeopleHeld && !w.participantPeopleHeld) return applyParticipantPeople(w, playerId);
    if (sign.id === "participant-people") return applyParticipantPeople(w, playerId);
    if (w.framePeopleHeld && !w.observerPeopleHeld) return applyObserverPeople(w, playerId);
    if (sign.id === "observer-people") return applyObserverPeople(w, playerId);
    if (w.paperPeopleHeld && !w.framePeopleHeld) return applyFramePeople(w, playerId);
    if (sign.id === "frame-people") return applyFramePeople(w, playerId);
    if (w.clinicPeopleHeld && !w.paperPeopleHeld) return applyPaperPeople(w, playerId);
    if (sign.id === "paper-people") return applyPaperPeople(w, playerId);
    if (w.gatherPeopleHeld && !w.clinicPeopleHeld) return applyClinicPeople(w, playerId);
    if (sign.id === "clinic-people") return applyClinicPeople(w, playerId);
...
export function applyClinicPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: CLINIC_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_CLINIC_PEOPLE) });
    return { ...w, players };
  }
  if (!w.gatherPeopleHeld) {
    players.set(playerId, { ...p, heard: CLINIC_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.clinicPeopleHeld && p.beats.clinicPeople) {
    players.set(playerId, { ...p, heard: CLINIC_PEOPLE_HELD, wink: visibleWink(false, WINK_CLINIC_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, clinicPeople: true },
    heard: CLINIC_PEOPLE_COPY,
    wink: visibleWink(false, WINK_CLINIC_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "clinic-people")
    ? w.pois.map((poi) => (poi.id === "clinic-people" ? clinicPeoplePoi() : poi))
    : [...w.pois, clinicPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "clinic-people")
    ? w.signs.map((s) => (s.id === "clinic-people" ? { ...CLINIC_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...CLINIC_PEOPLE_PLAQUE }];
  return { ...w, players, clinicPeopleHeld: true, pois, signs };
}

export function applyPaperPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: PAPER_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_PAPER_PEOPLE) });
    return { ...w, players };
  }
  if (!w.clinicPeopleHeld) {
    players.set(playerId, { ...p, heard: PAPER_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.paperPeopleHeld && p.beats.paperPeople) {
    players.set(playerId, { ...p, heard: PAPER_PEOPLE_HELD, wink: visibleWink(false, WINK_PAPER_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, paperPeople: true },
    heard: PAPER_PEOPLE_COPY,
    wink: visibleWink(false, WINK_PAPER_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "paper-people")
    ? w.pois.map((poi) => (poi.id === "paper-people" ? paperPeoplePoi() : poi))
    : [...w.pois, paperPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "paper-people")
    ? w.signs.map((s) => (s.id === "paper-people" ? { ...PAPER_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...PAPER_PEOPLE_PLAQUE }];
  return { ...w, players, paperPeopleHeld: true, pois, signs };
}

export function applyFramePeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: FRAME_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_FRAME_PEOPLE) });
    return { ...w, players };
  }
  if (!w.paperPeopleHeld) {
    players.set(playerId, { ...p, heard: FRAME_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.framePeopleHeld && p.beats.framePeople) {
    players.set(playerId, { ...p, heard: FRAME_PEOPLE_HELD, wink: visibleWink(false, WINK_FRAME_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, framePeople: true },
    heard: FRAME_PEOPLE_COPY,
    wink: visibleWink(false, WINK_FRAME_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "frame-people")
    ? w.pois.map((poi) => (poi.id === "frame-people" ? framePeoplePoi() : poi))
    : [...w.pois, framePeoplePoi()];
  const signs = w.signs.some((s) => s.id === "frame-people")
    ? w.signs.map((s) => (s.id === "frame-people" ? { ...FRAME_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...FRAME_PEOPLE_PLAQUE }];
  return { ...w, players, framePeopleHeld: true, pois, signs };
}

export function applyObserverPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: OBSERVER_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_OBSERVER_PEOPLE) });
    return { ...w, players };
  }
  if (!w.framePeopleHeld) {
    players.set(playerId, { ...p, heard: OBSERVER_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.observerPeopleHeld && p.beats.observerPeople) {
    players.set(playerId, { ...p, heard: OBSERVER_PEOPLE_HELD, wink: visibleWink(false, WINK_OBSERVER_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, observerPeople: true },
    heard: OBSERVER_PEOPLE_COPY,
    wink: visibleWink(false, WINK_OBSERVER_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "observer-people")
    ? w.pois.map((poi) => (poi.id === "observer-people" ? observerPeoplePoi() : poi))
    : [...w.pois, observerPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "observer-people")
    ? w.signs.map((s) => (s.id === "observer-people" ? { ...OBSERVER_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...OBSERVER_PEOPLE_PLAQUE }];
  return { ...w, players, observerPeopleHeld: true, pois, signs };
}

export function applyParticipantPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: PARTICIPANT_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_PARTICIPANT_PEOPLE) });
    return { ...w, players };
  }
  if (!w.observerPeopleHeld) {
    players.set(playerId, { ...p, heard: PARTICIPANT_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.participantPeopleHeld && p.beats.participantPeople) {
    players.set(playerId, { ...p, heard: PARTICIPANT_PEOPLE_HELD, wink: visibleWink(false, WINK_PARTICIPANT_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, participantPeople: true },
    heard: PARTICIPANT_PEOPLE_COPY,
    wink: visibleWink(false, WINK_PARTICIPANT_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "participant-people")
    ? w.pois.map((poi) => (poi.id === "participant-people" ? participantPeoplePoi() : poi))
    : [...w.pois, participantPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "participant-people")
    ? w.signs.map((s) => (s.id === "participant-people" ? { ...PARTICIPANT_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...PARTICIPANT_PEOPLE_PLAQUE }];
  return { ...w, players, participantPeopleHeld: true, pois, signs };
}

export function applyProximityPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: PROXIMITY_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_PROXIMITY_PEOPLE) });
    return { ...w, players };
  }
  if (!w.participantPeopleHeld) {
    players.set(playerId, { ...p, heard: PROXIMITY_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.proximityPeopleHeld && p.beats.proximityPeople) {
    players.set(playerId, { ...p, heard: PROXIMITY_PEOPLE_HELD, wink: visibleWink(false, WINK_PROXIMITY_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, proximityPeople: true },
    heard: PROXIMITY_PEOPLE_COPY,
    wink: visibleWink(false, WINK_PROXIMITY_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "proximity-people")
    ? w.pois.map((poi) => (poi.id === "proximity-people" ? proximityPeoplePoi() : poi))
    : [...w.pois, proximityPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "proximity-people")
    ? w.signs.map((s) => (s.id === "proximity-people" ? { ...PROXIMITY_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...PROXIMITY_PEOPLE_PLAQUE }];
  return { ...w, players, proximityPeopleHeld: true, pois, signs };
}

export function applyEnterPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: ENTER_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_ENTER_PEOPLE) });
    return { ...w, players };
  }
  if (!w.proximityPeopleHeld) {
    players.set(playerId, { ...p, heard: ENTER_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.enterPeopleHeld && p.beats.enterPeople) {
    players.set(playerId, { ...p, heard: ENTER_PEOPLE_HELD, wink: visibleWink(false, WINK_ENTER_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, enterPeople: true },
    heard: ENTER_PEOPLE_COPY,
    wink: visibleWink(false, WINK_ENTER_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "enter-people")
    ? w.pois.map((poi) => (poi.id === "enter-people" ? enterPeoplePoi() : poi))
    : [...w.pois, enterPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "enter-people")
    ? w.signs.map((s) => (s.id === "enter-people" ? { ...ENTER_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...ENTER_PEOPLE_PLAQUE }];
  return { ...w, players, enterPeopleHeld: true, pois, signs };
}

export function applyRefusePeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: REFUSE_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_REFUSE_PEOPLE) });
    return { ...w, players };
  }
  if (!w.enterPeopleHeld) {
    players.set(playerId, { ...p, heard: REFUSE_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.refusePeopleHeld && p.beats.refusePeople) {
    players.set(playerId, { ...p, heard: REFUSE_PEOPLE_HELD, wink: visibleWink(false, WINK_REFUSE_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, refusePeople: true },
    heard: REFUSE_PEOPLE_COPY,
    wink: visibleWink(false, WINK_REFUSE_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "refuse-people")
    ? w.pois.map((poi) => (poi.id === "refuse-people" ? refusePeoplePoi() : poi))
    : [...w.pois, refusePeoplePoi()];
  const signs = w.signs.some((s) => s.id === "refuse-people")
    ? w.signs.map((s) => (s.id === "refuse-people" ? { ...REFUSE_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...REFUSE_PEOPLE_PLAQUE }];
  return { ...w, players, refusePeopleHeld: true, pois, signs };
}

export function applyCollectivePeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: COLLECTIVE_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_COLLECTIVE_PEOPLE) });
    return { ...w, players };
  }
  if (!w.refusePeopleHeld) {
    players.set(playerId, { ...p, heard: COLLECTIVE_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.collectivePeopleHeld && p.beats.collectivePeople) {
    players.set(playerId, { ...p, heard: COLLECTIVE_PEOPLE_HELD, wink: visibleWink(false, WINK_COLLECTIVE_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, collectivePeople: true },
    heard: COLLECTIVE_PEOPLE_COPY,
    wink: visibleWink(false, WINK_COLLECTIVE_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "collective-people")
    ? w.pois.map((poi) => (poi.id === "collective-people" ? collectivePeoplePoi() : poi))
    : [...w.pois, collectivePeoplePoi()];
  const signs = w.signs.some((s) => s.id === "collective-people")
    ? w.signs.map((s) => (s.id === "collective-people" ? { ...COLLECTIVE_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...COLLECTIVE_PEOPLE_PLAQUE }];
  return { ...w, players, collectivePeopleHeld: true, pois, signs };
}

export function applyStudiosPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: STUDIOS_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_STUDIOS_PEOPLE) });
    return { ...w, players };
  }
  if (!w.collectivePeopleHeld) {
    players.set(playerId, { ...p, heard: STUDIOS_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.studiosPeopleHeld && p.beats.studiosPeople) {
    players.set(playerId, { ...p, heard: STUDIOS_PEOPLE_HELD, wink: visibleWink(false, WINK_STUDIOS_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, studiosPeople: true },
    heard: STUDIOS_PEOPLE_COPY,
    wink: visibleWink(false, WINK_STUDIOS_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "studios-people")
    ? w.pois.map((poi) => (poi.id === "studios-people" ? studiosPeoplePoi() : poi))
    : [...w.pois, studiosPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "studios-people")
    ? w.signs.map((s) => (s.id === "studios-people" ? { ...STUDIOS_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...STUDIOS_PEOPLE_PLAQUE }];
  return { ...w, players, studiosPeopleHeld: true, pois, signs };
}

export function applyFilmPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: FILM_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_FILM_PEOPLE) });
    return { ...w, players };
  }
  if (!w.studiosPeopleHeld) {
    players.set(playerId, { ...p, heard: FILM_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.filmPeopleHeld && p.beats.filmPeople) {
    players.set(playerId, { ...p, heard: FILM_PEOPLE_HELD, wink: visibleWink(false, WINK_FILM_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, filmPeople: true },
    heard: FILM_PEOPLE_COPY,
    wink: visibleWink(false, WINK_FILM_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "film-people")
    ? w.pois.map((poi) => (poi.id === "film-people" ? filmPeoplePoi() : poi))
    : [...w.pois, filmPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "film-people")
    ? w.signs.map((s) => (s.id === "film-people" ? { ...FILM_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...FILM_PEOPLE_PLAQUE }];
  return { ...w, players, filmPeopleHeld: true, pois, signs };
}

export function applyDirectorPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: DIRECTOR_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_DIRECTOR_PEOPLE) });
    return { ...w, players };
  }
  if (!w.filmPeopleHeld) {
    players.set(playerId, { ...p, heard: DIRECTOR_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.directorPeopleHeld && p.beats.directorPeople) {
    players.set(playerId, { ...p, heard: DIRECTOR_PEOPLE_HELD, wink: visibleWink(false, WINK_DIRECTOR_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, directorPeople: true },
    heard: DIRECTOR_PEOPLE_COPY,
    wink: visibleWink(false, WINK_DIRECTOR_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "director-people")
    ? w.pois.map((poi) => (poi.id === "director-people" ? directorPeoplePoi() : poi))
    : [...w.pois, directorPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "director-people")
    ? w.signs.map((s) => (s.id === "director-people" ? { ...DIRECTOR_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...DIRECTOR_PEOPLE_PLAQUE }];
  return { ...w, players, directorPeopleHeld: true, pois, signs };
}

export function applyDisarmedPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: DISARMED_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_DISARMED_PEOPLE) });
    return { ...w, players };
  }
  if (!w.directorPeopleHeld) {
    players.set(playerId, { ...p, heard: DISARMED_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.disarmedPeopleHeld && p.beats.disarmedPeople) {
    players.set(playerId, { ...p, heard: DISARMED_PEOPLE_HELD, wink: visibleWink(false, WINK_DISARMED_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, disarmedPeople: true },
    heard: DISARMED_PEOPLE_COPY,
    wink: visibleWink(false, WINK_DISARMED_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "disarmed-people")
    ? w.pois.map((poi) => (poi.id === "disarmed-people" ? disarmedPeoplePoi() : poi))
    : [...w.pois, disarmedPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "disarmed-people")
    ? w.signs.map((s) => (s.id === "disarmed-people" ? { ...DISARMED_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...DISARMED_PEOPLE_PLAQUE }];
  return { ...w, players, disarmedPeopleHeld: true, pois, signs };
}

export function applyGuestPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: GUEST_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_GUEST_PEOPLE) });
    return { ...w, players };
  }
  if (!w.disarmedPeopleHeld) {
    players.set(playerId, { ...p, heard: GUEST_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.guestPeopleHeld && p.beats.guestPeople) {
    players.set(playerId, { ...p, heard: GUEST_PEOPLE_HELD, wink: visibleWink(false, WINK_GUEST_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, guestPeople: true },
    heard: GUEST_PEOPLE_COPY,
    wink: visibleWink(false, WINK_GUEST_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "guest-people")
    ? w.pois.map((poi) => (poi.id === "guest-people" ? guestPeoplePoi() : poi))
    : [...w.pois, guestPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "guest-people")
    ? w.signs.map((s) => (s.id === "guest-people" ? { ...GUEST_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...GUEST_PEOPLE_PLAQUE }];
  return { ...w, players, guestPeopleHeld: true, pois, signs };
}

export function applySupplyPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: SUPPLY_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_SUPPLY_PEOPLE) });
    return { ...w, players };
  }
  if (!w.guestPeopleHeld) {
    players.set(playerId, { ...p, heard: SUPPLY_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.supplyPeopleHeld && p.beats.supplyPeople) {
    players.set(playerId, { ...p, heard: SUPPLY_PEOPLE_HELD, wink: visibleWink(false, WINK_SUPPLY_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, supplyPeople: true },
    heard: SUPPLY_PEOPLE_COPY,
    wink: visibleWink(false, WINK_SUPPLY_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "supply-people")
    ? w.pois.map((poi) => (poi.id === "supply-people" ? supplyPeoplePoi() : poi))
    : [...w.pois, supplyPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "supply-people")
    ? w.signs.map((s) => (s.id === "supply-people" ? { ...SUPPLY_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...SUPPLY_PEOPLE_PLAQUE }];
  return { ...w, players, supplyPeopleHeld: true, pois, signs };
}

export function applyCombatPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: COMBAT_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_COMBAT_PEOPLE) });
    return { ...w, players };
  }
  if (!w.supplyPeopleHeld) {
    players.set(playerId, { ...p, heard: COMBAT_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.combatPeopleHeld && p.beats.combatPeople) {
    players.set(playerId, { ...p, heard: COMBAT_PEOPLE_HELD, wink: visibleWink(false, WINK_COMBAT_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, combatPeople: true },
    heard: COMBAT_PEOPLE_COPY,
    wink: visibleWink(false, WINK_COMBAT_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "combat-people")
    ? w.pois.map((poi) => (poi.id === "combat-people" ? combatPeoplePoi() : poi))
    : [...w.pois, combatPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "combat-people")
    ? w.signs.map((s) => (s.id === "combat-people" ? { ...COMBAT_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...COMBAT_PEOPLE_PLAQUE }];
  return { ...w, players, combatPeopleHeld: true, pois, signs };
}

export function applyEarnPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: EARN_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_EARN_PEOPLE) });
    return { ...w, players };
  }
  if (!w.combatPeopleHeld) {
    players.set(playerId, { ...p, heard: EARN_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.earnPeopleHeld && p.beats.earnPeople) {
    players.set(playerId, { ...p, heard: EARN_PEOPLE_HELD, wink: visibleWink(false, WINK_EARN_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, earnPeople: true },
    heard: EARN_PEOPLE_COPY,
    wink: visibleWink(false, WINK_EARN_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "earn-people")
    ? w.pois.map((poi) => (poi.id === "earn-people" ? earnPeoplePoi() : poi))
    : [...w.pois, earnPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "earn-people")
    ? w.signs.map((s) => (s.id === "earn-people" ? { ...EARN_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...EARN_PEOPLE_PLAQUE }];
  return { ...w, players, earnPeopleHeld: true, pois, signs };
}

export function applyAngelPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: ANGEL_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_ANGEL_PEOPLE) });
    return { ...w, players };
  }
  if (!w.earnPeopleHeld) {
    players.set(playerId, { ...p, heard: ANGEL_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.angelPeopleHeld && p.beats.angelPeople) {
    players.set(playerId, { ...p, heard: ANGEL_PEOPLE_HELD, wink: visibleWink(false, WINK_ANGEL_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, angelPeople: true },
    heard: ANGEL_PEOPLE_COPY,
    wink: visibleWink(false, WINK_ANGEL_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "angel-people")
    ? w.pois.map((poi) => (poi.id === "angel-people" ? angelPeoplePoi() : poi))
    : [...w.pois, angelPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "angel-people")
    ? w.signs.map((s) => (s.id === "angel-people" ? { ...ANGEL_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...ANGEL_PEOPLE_PLAQUE }];
  return { ...w, players, angelPeopleHeld: true, pois, signs };
}

export function applyMessengerPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: MESSENGER_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_MESSENGER_PEOPLE) });
    return { ...w, players };
  }
  if (!w.angelPeopleHeld) {
    players.set(playerId, { ...p, heard: MESSENGER_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.messengerPeopleHeld && p.beats.messengerPeople) {
    players.set(playerId, { ...p, heard: MESSENGER_PEOPLE_HELD, wink: visibleWink(false, WINK_MESSENGER_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, messengerPeople: true },
    heard: MESSENGER_PEOPLE_COPY,
    wink: visibleWink(false, WINK_MESSENGER_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "messenger-people")
    ? w.pois.map((poi) => (poi.id === "messenger-people" ? messengerPeoplePoi() : poi))
    : [...w.pois, messengerPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "messenger-people")
    ? w.signs.map((s) => (s.id === "messenger-people" ? { ...MESSENGER_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...MESSENGER_PEOPLE_PLAQUE }];
  return { ...w, players, messengerPeopleHeld: true, pois, signs };
}

export function applyLinkPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: LINK_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_LINK_PEOPLE) });
    return { ...w, players };
  }
  if (!w.messengerPeopleHeld) {
    players.set(playerId, { ...p, heard: LINK_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.linkPeopleHeld && p.beats.linkPeople) {
    players.set(playerId, { ...p, heard: LINK_PEOPLE_HELD, wink: visibleWink(false, WINK_LINK_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, linkPeople: true },
    heard: LINK_PEOPLE_COPY,
    wink: visibleWink(false, WINK_LINK_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "link-people")
    ? w.pois.map((poi) => (poi.id === "link-people" ? linkPeoplePoi() : poi))
    : [...w.pois, linkPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "link-people")
    ? w.signs.map((s) => (s.id === "link-people" ? { ...LINK_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...LINK_PEOPLE_PLAQUE }];
  return { ...w, players, linkPeopleHeld: true, pois, signs };
}

export function applyPerceptionPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: PERCEPTION_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_PERCEPTION_PEOPLE) });
    return { ...w, players };
  }
  if (!w.linkPeopleHeld) {
    players.set(playerId, { ...p, heard: PERCEPTION_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.perceptionPeopleHeld && p.beats.perceptionPeople) {
    players.set(playerId, { ...p, heard: PERCEPTION_PEOPLE_HELD, wink: visibleWink(false, WINK_PERCEPTION_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, perceptionPeople: true },
    heard: PERCEPTION_PEOPLE_COPY,
    wink: visibleWink(false, WINK_PERCEPTION_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "perception-people")
    ? w.pois.map((poi) => (poi.id === "perception-people" ? perceptionPeoplePoi() : poi))
    : [...w.pois, perceptionPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "perception-people")
    ? w.signs.map((s) => (s.id === "perception-people" ? { ...PERCEPTION_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...PERCEPTION_PEOPLE_PLAQUE }];
  return { ...w, players, perceptionPeopleHeld: true, pois, signs };
}

export function applyVerbPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: VERB_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_VERB_PEOPLE) });
    return { ...w, players };
  }
  if (!w.perceptionPeopleHeld) {
    players.set(playerId, { ...p, heard: VERB_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.verbPeopleHeld && p.beats.verbPeople) {
    players.set(playerId, { ...p, heard: VERB_PEOPLE_HELD, wink: visibleWink(false, WINK_VERB_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, verbPeople: true },
    heard: VERB_PEOPLE_COPY,
    wink: visibleWink(false, WINK_VERB_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "verb-people")
    ? w.pois.map((poi) => (poi.id === "verb-people" ? verbPeoplePoi() : poi))
    : [...w.pois, verbPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "verb-people")
    ? w.signs.map((s) => (s.id === "verb-people" ? { ...VERB_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...VERB_PEOPLE_PLAQUE }];
  return { ...w, players, verbPeopleHeld: true, pois, signs };
}

export function applyStylePeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: STYLE_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_STYLE_PEOPLE) });
    return { ...w, players };
  }
  if (!w.verbPeopleHeld) {
    players.set(playerId, { ...p, heard: STYLE_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.stylePeopleHeld && p.beats.stylePeople) {
    players.set(playerId, { ...p, heard: STYLE_PEOPLE_HELD, wink: visibleWink(false, WINK_STYLE_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, stylePeople: true },
    heard: STYLE_PEOPLE_COPY,
    wink: visibleWink(false, WINK_STYLE_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "style-people")
    ? w.pois.map((poi) => (poi.id === "style-people" ? stylePeoplePoi() : poi))
    : [...w.pois, stylePeoplePoi()];
  const signs = w.signs.some((s) => s.id === "style-people")
    ? w.signs.map((s) => (s.id === "style-people" ? { ...STYLE_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...STYLE_PEOPLE_PLAQUE }];
  return { ...w, players, stylePeopleHeld: true, pois, signs };
}

export function applySchoolPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: SCHOOL_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_SCHOOL_PEOPLE) });
    return { ...w, players };
  }
  if (!w.stylePeopleHeld) {
    players.set(playerId, { ...p, heard: SCHOOL_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.schoolPeopleHeld && p.beats.schoolPeople) {
    players.set(playerId, { ...p, heard: SCHOOL_PEOPLE_HELD, wink: visibleWink(false, WINK_SCHOOL_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, schoolPeople: true },
    heard: SCHOOL_PEOPLE_COPY,
    wink: visibleWink(false, WINK_SCHOOL_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "school-people")
    ? w.pois.map((poi) => (poi.id === "school-people" ? schoolPeoplePoi() : poi))
    : [...w.pois, schoolPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "school-people")
    ? w.signs.map((s) => (s.id === "school-people" ? { ...SCHOOL_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...SCHOOL_PEOPLE_PLAQUE }];
  return { ...w, players, schoolPeopleHeld: true, pois, signs };
}

export function applyOptionalPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: OPTIONAL_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_OPTIONAL_PEOPLE) });
    return { ...w, players };
  }
  if (!w.schoolPeopleHeld) {
    players.set(playerId, { ...p, heard: OPTIONAL_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.optionalPeopleHeld && p.beats.optionalPeople) {
    players.set(playerId, { ...p, heard: OPTIONAL_PEOPLE_HELD, wink: visibleWink(false, WINK_OPTIONAL_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, optionalPeople: true },
    heard: OPTIONAL_PEOPLE_COPY,
    wink: visibleWink(false, WINK_OPTIONAL_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "optional-people")
    ? w.pois.map((poi) => (poi.id === "optional-people" ? optionalPeoplePoi() : poi))
    : [...w.pois, optionalPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "optional-people")
    ? w.signs.map((s) => (s.id === "optional-people" ? { ...OPTIONAL_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...OPTIONAL_PEOPLE_PLAQUE }];
  return { ...w, players, optionalPeopleHeld: true, pois, signs };
}

export function applyPersonalPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: PERSONAL_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_PERSONAL_PEOPLE) });
    return { ...w, players };
  }
  if (!w.optionalPeopleHeld) {
    players.set(playerId, { ...p, heard: PERSONAL_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.personalPeopleHeld && p.beats.personalPeople) {
    players.set(playerId, { ...p, heard: PERSONAL_PEOPLE_HELD, wink: visibleWink(false, WINK_PERSONAL_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, personalPeople: true },
    heard: PERSONAL_PEOPLE_COPY,
    wink: visibleWink(false, WINK_PERSONAL_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "personal-people")
    ? w.pois.map((poi) => (poi.id === "personal-people" ? personalPeoplePoi() : poi))
    : [...w.pois, personalPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "personal-people")
    ? w.signs.map((s) => (s.id === "personal-people" ? { ...PERSONAL_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...PERSONAL_PEOPLE_PLAQUE }];
  return { ...w, players, personalPeopleHeld: true, pois, signs };
}

export function applyVariantPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: VARIANT_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_VARIANT_PEOPLE) });
    return { ...w, players };
  }
  if (!w.personalPeopleHeld) {
    players.set(playerId, { ...p, heard: VARIANT_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.variantPeopleHeld && p.beats.variantPeople) {
    players.set(playerId, { ...p, heard: VARIANT_PEOPLE_HELD, wink: visibleWink(false, WINK_VARIANT_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, variantPeople: true },
    heard: VARIANT_PEOPLE_COPY,
    wink: visibleWink(false, WINK_VARIANT_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "variant-people")
    ? w.pois.map((poi) => (poi.id === "variant-people" ? variantPeoplePoi() : poi))
    : [...w.pois, variantPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "variant-people")
    ? w.signs.map((s) => (s.id === "variant-people" ? { ...VARIANT_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...VARIANT_PEOPLE_PLAQUE }];
  return { ...w, players, variantPeopleHeld: true, pois, signs };
}

export function applyObjectivePeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: OBJECTIVE_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_OBJECTIVE_PEOPLE) });
    return { ...w, players };
  }
  if (!w.variantPeopleHeld) {
    players.set(playerId, { ...p, heard: OBJECTIVE_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.objectivePeopleHeld && p.beats.objectivePeople) {
    players.set(playerId, { ...p, heard: OBJECTIVE_PEOPLE_HELD, wink: visibleWink(false, WINK_OBJECTIVE_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, objectivePeople: true },
    heard: OBJECTIVE_PEOPLE_COPY,
    wink: visibleWink(false, WINK_OBJECTIVE_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "objective-people")
    ? w.pois.map((poi) => (poi.id === "objective-people" ? objectivePeoplePoi() : poi))
    : [...w.pois, objectivePeoplePoi()];
  const signs = w.signs.some((s) => s.id === "objective-people")
    ? w.signs.map((s) => (s.id === "objective-people" ? { ...OBJECTIVE_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...OBJECTIVE_PEOPLE_PLAQUE }];
  return { ...w, players, objectivePeopleHeld: true, pois, signs };
}

export function applyQuestPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: QUEST_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_QUEST_PEOPLE) });
    return { ...w, players };
  }
  if (!w.objectivePeopleHeld) {
    players.set(playerId, { ...p, heard: QUEST_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.questPeopleHeld && p.beats.questPeople) {
    players.set(playerId, { ...p, heard: QUEST_PEOPLE_HELD, wink: visibleWink(false, WINK_QUEST_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, questPeople: true },
    heard: QUEST_PEOPLE_COPY,
    wink: visibleWink(false, WINK_QUEST_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "quest-people")
    ? w.pois.map((poi) => (poi.id === "quest-people" ? questPeoplePoi() : poi))
    : [...w.pois, questPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "quest-people")
    ? w.signs.map((s) => (s.id === "quest-people" ? { ...QUEST_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...QUEST_PEOPLE_PLAQUE }];
  return { ...w, players, questPeopleHeld: true, pois, signs };
}

export function applySpokenPeople(w: WorldState, playerId: string): WorldState {
  const p = w.players.get(playerId);
  if (!p || p.hp <= 0 || !inWetGrid(p.x, p.y)) return w;
  const players = new Map(w.players);
  if (p.guest || p.locked) {
    players.set(playerId, { ...p, heard: SPOKEN_PEOPLE_SPECTATOR, wink: visibleWink(true, WINK_SPOKEN_PEOPLE) });
    return { ...w, players };
  }
  if (!w.questPeopleHeld) {
    players.set(playerId, { ...p, heard: SPOKEN_PEOPLE_NEED });
    return { ...w, players };
  }
  if (w.spokenPeopleHeld && p.beats.spokenPeople) {
    players.set(playerId, { ...p, heard: SPOKEN_PEOPLE_HELD, wink: visibleWink(false, WINK_SPOKEN_PEOPLE) });
    return { ...w, players };
  }
  players.set(playerId, {
    ...p,
    beats: { ...p.beats, spokenPeople: true },
    heard: SPOKEN_PEOPLE_COPY,
    wink: visibleWink(false, WINK_SPOKEN_PEOPLE),
  });
  const pois = w.pois.some((poi) => poi.id === "spoken-people")
    ? w.pois.map((poi) => (poi.id === "spoken-people" ? spokenPeoplePoi() : poi))
    : [...w.pois, spokenPeoplePoi()];
  const signs = w.signs.some((s) => s.id === "spoken-people")
    ? w.signs.map((s) => (s.id === "spoken-people" ? { ...SPOKEN_PEOPLE_PLAQUE } : s))
    : [...w.signs, { ...SPOKEN_PEOPLE_PLAQUE }];
  return { ...w, players, spokenPeopleHeld: true, pois, signs };
}
...
export function snapshot(w: WorldState, viewerId?: string) {
  return {
    ...
    clinicPeopleHeld: w.clinicPeopleHeld,
    paperPeopleHeld: w.paperPeopleHeld,
    framePeopleHeld: w.framePeopleHeld,
    observerPeopleHeld: w.observerPeopleHeld,
    participantPeopleHeld: w.participantPeopleHeld,
    proximityPeopleHeld: w.proximityPeopleHeld,
    enterPeopleHeld: w.enterPeopleHeld,
    refusePeopleHeld: w.refusePeopleHeld,
    collectivePeopleHeld: w.collectivePeopleHeld,
    studiosPeopleHeld: w.studiosPeopleHeld,
    filmPeopleHeld: w.filmPeopleHeld,
    directorPeopleHeld: w.directorPeopleHeld,
    disarmedPeopleHeld: w.disarmedPeopleHeld,
    guestPeopleHeld: w.guestPeopleHeld,
    supplyPeopleHeld: w.supplyPeopleHeld,
    combatPeopleHeld: w.combatPeopleHeld,
    earnPeopleHeld: w.earnPeopleHeld,
    angelPeopleHeld: w.angelPeopleHeld,
    messengerPeopleHeld: w.messengerPeopleHeld,
    linkPeopleHeld: w.linkPeopleHeld,
    perceptionPeopleHeld: w.perceptionPeopleHeld,
    verbPeopleHeld: w.verbPeopleHeld,
    stylePeopleHeld: w.stylePeopleHeld,
    schoolPeopleHeld: w.schoolPeopleHeld,
    optionalPeopleHeld: w.optionalPeopleHeld,
    personalPeopleHeld: w.personalPeopleHeld,
    variantPeopleHeld: w.variantPeopleHeld,
    objectivePeopleHeld: w.objectivePeopleHeld,
    questPeopleHeld: w.questPeopleHeld,
    spokenPeopleHeld: w.spokenPeopleHeld,
